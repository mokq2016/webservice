 ...
 * 2016-09-25T13:58:38.464+08:00
 * Generated source version: 3.1.7
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", 
                  wsdlLocation = "http://localhost:8080/WS_Spring_CXF/webservice/HelloWorld?wsdl",
                  targetNamespace = "http://impl.webservice.java1234.com/") 
public class HelloWorldImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://impl.webservice.java1234.com/", "HelloWorldImplService");
    public final static QName HelloWorldImplPort = new QName("http://impl.webservice.java1234.com/", "HelloWorldImplPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/WS_Spring_CXF/webservice/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/WS_Spring_CXF/webservice/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
